    ...
    def POST(self):        
        ...
        if mstype == "event":
            ...
            if mscontent == "subscribe":
                replayText = u'''欢迎关注本微信，这个微信是本人业余爱好所建立，也是想一边学习Python一边玩的东西,现在还没有什么功能，输入help查看操作指令'''
        ...
        if mstype == 'text':
            ...
            if content == 'help':
                ...
                return self.render.reply_text(fromUser,toUser,int(time.time()),u'点击下面网址查看更多粮油推荐信息：http://grainanalysis.applinzi.com/recommendPosNeg')
